...
const Review = () => {
  return (
    <div className="bg-[#CECECE] p-10 text-center ">
          <h2 className="text-xl font-semibold text-[#E1971B]">Guest Review</h2>
          <div className="flex justify-center items-center mt-2">
            <FaQuoteLeft className="text-xl text-[#295757] mb-7" />
            <h1 className="text-3xl font-bold mx-2 font-playfair">What people say about us</h1>
          ...
          <div className="flex flex-col items-center mt-4">
            ...
            />
            <h3 className="mt-2 font-semibold text-lg font-playfair">Arbin Acharya</h3>
