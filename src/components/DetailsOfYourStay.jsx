...
<div className=' absolute inset-0 flex items-center justify-center'>
    <h2 className=' text-white text-5xl font-extrabold'>Booking</h2>
      ...
      <div className=' flex flex-col items-center justify-center mt-5 p-4'>
        ...
        <div className=' bg-white p-6 rounded-lg shadow-md w-full max-w-2xl sm:w-11/12'>
...
<div className=' items-center text-center'>
            ...
            <button className=' bg-[#E1971B] text-white  rounded-3xl hover:bg-yellow-600 py-2 px-14'>Booked</button>
</div>
        </div>
